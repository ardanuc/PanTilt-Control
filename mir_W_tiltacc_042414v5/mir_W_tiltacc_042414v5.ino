...
Version REvision:5
ADded carriage return "\r" as the end of input strnig character to make it communicate with the Putty, since Putty does not
seem to add a newline character "\n"
See the parameter:
